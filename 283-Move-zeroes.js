...
function moveZeroes(nums){           // function with nums
...
let j = 0;
    ...
    return nums;                        // returning nums outside ther while loop. 
}
console.log(moveZeroes([0,1,0,3,12])); //consoling and calling the function.
